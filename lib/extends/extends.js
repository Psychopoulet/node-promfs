...
// deps
	...
	const writeJSONFile = require(path.join(__dirname, "_writeJSONFile.js"));
...
// module
	...
	// filesToStream
		...
		fs.filesToStreamSync = filesToStream.filesToStreamSync;
	...
	// directoryToStream
		...
		fs.directoryToStreamSync = directoryToStream.directoryToStreamSync;
