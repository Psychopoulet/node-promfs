			...
			if ("undefined" === typeof path) {
				...
				if ("" === _path) {
					...
					return new Promise((resolve, reject) => {
						...
						fs.open(_path, flags, mode ? mode : null, (err, fd) => {
	...
	// others
			...
			if ("undefined" === typeof path) {
				...
				if ("" === _path) {
					...
					return new Promise((resolve, reject) => {
						...
						fs.access(_path, mode ? mode : null, (err, result) => {
			...
			if ("undefined" === typeof path) {
				...
				if ("" === _path) {
					...
					return new Promise((resolve, reject) => {
						...
						fs.realpath(_path, options ? options : null, (err, result) => {
		...
		[
			...
			// classical
				...
				// others
				"link", "lstat", "mkdtemp", "utimes", "write"
