...
fs.openProm = function (path, flags, mode) {
	...
	if ("undefined" === typeof path) {
		...
		return "" === _path ? Promise.reject(new Error("\"path\" argument is empty")) : new Promise(function (resolve, reject) {

			fs.open(_path, flags, "undefined" !== typeof mode ? mode : null, function (err, fd) {
...
fs.accessProm = function (path, mode) {
	...
	if ("undefined" === typeof path) {
		...
		return "" === _path ? Promise.reject(new Error("\"path\" argument is empty")) : new Promise(function (resolve, reject) {
			...
			fs.access(_path, "undefined" !== typeof mode ? mode : null, function (err, result) {
...
fs.appendFileProm = function (file, data, options) {
	...
	if ("undefined" === typeof file) {
		...
		return "" === _file ? Promise.reject(new Error("\"file\" argument is empty")) : new Promise(function (resolve, reject) {
...
fs.realpathProm = function (path, options) {
	...
	if ("undefined" === typeof path) {
		...
		return "" === _path ? Promise.reject(new Error("\"path\" argument is empty")) : new Promise(function (resolve, reject) {
			...
			fs.realpath(_path, "undefined" !== typeof options ? options : null, function (err, result) {
				return err ? reject(err) : resolve(result);
			});
		});
	}
	...
	fs[name + "Prom"] = function () {
		...
		return new Promise(function (resolve, reject) {
			...
			fs[name].apply(fs, args.concat([function () {
				...
				return err ? reject(err) : resolve.apply(undefined, subargs);
			}]));
		});
	};
});
